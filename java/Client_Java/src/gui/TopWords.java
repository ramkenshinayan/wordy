...
import clientInt.WordyModule.TopLongestWord;
...
public class TopWords extends JFrame {
    ...
    private void initComponents() {
        ...
        int availableEntries = wordyImpl.getLongestWordsSize();
        for (int rowIndex = 0; rowIndex < 5; rowIndex++) {
            if (rowIndex < availableEntries) {
                TopLongestWord topLongestWord = wordyImpl.getLongestWord(rowIndex);
                String username = topLongestWord.username;
                String word = topLongestWord.word;
                Integer letterCount = topLongestWord.letterCount;
                leaderboardsTable.getModel().setValueAt(username, rowIndex, 0);
                leaderboardsTable.getModel().setValueAt(word, rowIndex, 1);
                leaderboardsTable.getModel().setValueAt(letterCount, rowIndex, 2);
            } else {
        ...
        jScrollPane2.setBounds(62, 280, 720, 268);
        ...
        background.setIcon(new javax.swing.ImageIcon("Client_Java\\res\\wordsBoard.jpg")); // NOI18N
